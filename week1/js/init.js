...
const map = new maplibregl.Map({
    ...
    style: 'https://api.maptiler.com/maps/streets-v2-light/style.json?key=7w3ejiOsCvODMfBB0ggd', // Your style URL
...
new maplibregl.Marker()
    ...
    .setPopup(new maplibregl.Popup({ offset: 25 }) // Add popups
        .setHTML('<div class="lib"> Biomedical Library</tags></div>  '))
    .addTo(map);
